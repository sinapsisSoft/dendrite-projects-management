...
class Filing extends BaseController{
    ...
    public function __construct()
    {
        ...
        $this->primaryKey = 'Filing_id';
        $this->nameModel = 'filings';
    }
    ...
    public function show(){
        ...
        return view('filing/filing', $data);
    }
    ...
    public function getDataModel($getShares)
    {
        $data = [
            'Filing_id' => $getShares,
            'Filing_name' => $this->request->getVar('Filing_name'),
            'Filing_description' => $this->request->getVar('Filing_description'),
