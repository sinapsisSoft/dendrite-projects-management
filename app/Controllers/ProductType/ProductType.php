...
class ProductType extends BaseController{
    ...
    {
        $this->objModel = new ProductTypeModel();
        $this->primaryKey = 'TypePro_id';
        $this->nameModel = 'producttypes';
    }

    public function show(){
        $data['title'] = 'Tipo de productos';
    ...
    {
        $data = [
            'TypePro_id' => $getShares,
            'TypePro_name' => $this->request->getVar('TypePro_name'),
            'TypePro_description' => $this->request->getVar('TypePro_description'),
