                            ...
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                              <?php if (PERMITS[1]== "2"): ?>
                                <button type="button" class="btn btn-outline-warning"
                                  onclick="getDataId(<?= $obj['Mod_id'] ?>, 1)"><svg xmlns="http://www.w3.org/2000/svg"
                              ...
                              <?php if (PERMITS[2] == "3"): ?>
                                <button type="button" class="btn btn-outline-success"
                                  onclick="getDataId(<?= $obj['Mod_id'] ?>, 0)"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <button type="button" class="btn btn-outline-danger"
                                  onclick="delete_(<?= $obj['Mod_id'] ?>)"><svg xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content" style="width: 100%;">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" id="btn-submit" form="objForm"
                  class="btn btn-primary mx-auto w-50">Guardar</button>
              </div>
            </div>
          </div>
        </div>
