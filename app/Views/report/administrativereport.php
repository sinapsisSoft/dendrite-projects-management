                ...
                <div class="row reportChart align-items-center justify-content-center">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="row justify-content-center">
                      <div id="chart1Report" class="col-lg-6 col-10 my-3 shadow-sm">
                        <canvas id="chart1" style="width: 100%;"></canvas>
                      </div>
                      <div id="chart3Report" class="col-lg-6 col-10 my-3 shadow-sm">
                        ...
                        <table id="table_obj" class="table table-striped table-bordered">
                          ...
                          <tbody>
                            ...
                            <?php foreach ($dataTable as $obj) : ?>
                              <tr>
                                <td><?= $i++; ?></td>
                                <td><?= 'REQ_' . $obj->ProjReq_id; ?></td>
                                <td><?= $obj->Client_name; ?></td>
                                <td><?= $obj->Manager_name; ?></td>
                                <td><?= $obj->Brand_name; ?></td>
                                <td><?= $obj->Prod_name == null ? '' : $obj->Prod_name; ?></td>
                                <td><?= $obj->ProjReq_name; ?></td>
                                <td><?= $obj->Project_code == null ? '' : $obj->Project_code; ?></td>
                                <td><?= $obj->User_name == null ? '' : $obj->User_name; ?></td>
                                <td><?= $obj->Stat_name; ?></td>
