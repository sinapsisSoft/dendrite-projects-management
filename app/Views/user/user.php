                    ...
                    <div class="modal-dialog modal-dialog-scrollable modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="email" class="form-control" id="User_email" placeholder="user@example.com">
                                    ...
                                    <div class="mb-3">
                                        <label for="confirmPassword">User Company</label>
                                        <select class="form-select form-select-sm" id="Comp_id" name="Comp_id" aria-label=".form-select-sm example">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select form-select-sm" id="Stat_id" name="Stat_id" aria-label=".form-select-sm example">
                                            <option selected>Open this select menu</option>
                                            <option value="1">One</option>
                                            <option value="2">Two</option>
                                            <option value="3">Three</option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select form-select-sm" id="Role_id" name="Role_id" aria-label=".form-select-sm example">
                                            <option selected>Open this select menu</option>
                                            <option value="1">One</option>
                                            <option value="2">Two</option>
                                            <option value="3">Three</option>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary mx-auto w-50" >Save changes</button>
                            </div>
                        </div>
                    </div>
                </div>
