                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal mt-3 row" id="objForm" action="" onsubmit="sendData(event,this.id)">
                                <input type="hidden" class="form-control" id="Email_id" name="Email_id" value="0">
                                ...
                                <div class="mb-3 col-4">
                                    ...
                                    <input type="text" class="form-control" id="Email_pass" name="Email_pass" required>
                                </div>
                                <div class="mb-3 col-8">
                                ...
                                <div class="mb-3 col-4">
                                    ...
                                    <input type="text" class="form-control" id="Email_puerto" name="Email_puerto" required>
                                </div>
                            </form>
                        </div>
