                            ...
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-primary text-white h-100" style="cursor: pointer;" id="basic-addon1"><i class="mdi mdi-eye fs-4" id="iconPasswordRepeat" onclick="viewInputPassword('Repeat_User_password','iconPasswordRepeat')"></i></span>
                                    </div>
<input type="password" id="Repeat_User_password" name="Repeat_User_password" value="<?= old('Repeat_User_password') ?>" class="form-control form-control-lg" pattern="^(?=.*\d)(?=.*[\u0021-\u002b\u003c-\u0040])(?=.*[A-Z])(?=.*[a-z])\S{8,16}$" title="La contraseña debe tener entre 8 y 16 caracteres. Al menos un dígito. Al menos una minúscula. Al menos una mayúscula y al menos un caracter no alfanumérico." placeholder="Digitar nueva contraseña" aria-label="Repeat_User_password" aria-describedby="basic-addon1" required />
...
<input type="password" id="User_password" name="User_password" class="form-control form-control-lg" pattern="^(?=.*\d)(?=.*[\u0021-\u002b\u003c-\u0040])(?=.*[A-Z])(?=.*[a-z])\S{8,16}$" title="La contraseña debe tener entre 8 y 16 caracteres. Al menos un dígito. Al menos una minúscula. Al menos una mayúscula y al menos un caracter no alfanumérico." placeholder="Repetir nueva contraseña" aria-label="User_password" aria-describedby="basic-addon1" required />
                                ...
                                <div class="form-group">
                                    <div class="pt-3">
                                        <button class="btn btn-primary float-end text-white w-100" type="submit">
                                            <i class="mdi mdi-lock fs-4 me-1"></i> Cambiar contraseña
                                        </button>
                                    </div>
                                </div>
                            </div>
