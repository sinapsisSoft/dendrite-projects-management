                        ...
                        <div class="row pb-4">
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" pattern="^(?=.*\d)(?=.*[\u0021-\u002b\u003c-\u0040])(?=.*[A-Z])(?=.*[a-z])\S{8,16}$" title="La contraseña debe tener al entre 8 y 16 caracteres, al menos un dígito, al menos una minúscula, al menos una mayúscula y al menos un caracter no alfanumérico." id="User_password" name="User_password" class="form-control form-control-lg" placeholder="Digitar Contraseña" aria-label="User_password" aria-describedby="basic-addon1" require />
                    ...
                    <div class="row mt-3">
                        ...
                        <form class="col-12" action="" id="formRecoveryPassword" onsubmit="recoveryPassword(event,this.id)">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email" class="form-control form-control-lg" placeholder="Email user" id="User_email" name="User_email" aria-label="User_email" aria-describedby="basic-addon1" required />
