                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                              ...
                              <?php endif; ?>
                              <?php if (PERMITS[3] == "4") : ?>
                                <button type="button" class="btn btn-outline-danger" onclick="delete_(<?= $obj['City_id'] ?>)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
