          ...
          <div class="tab-content" id="myTabContent">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                              ...
                              <button type="button" class="btn btn-outline-success" onclick="showEmailModal(1, <?= $obj->SubAct_id ?>)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-plus-fill" viewBox="0 0 16 16">
                    ...
                    <form class="form-horizontal mt-3" id="objForm" action="" onsubmit="sendData(event,this.id)">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-4 mb-3">
                          ...
                          <input type="date" class="form-control form-disabled read" id="SubAct_endDate" name="SubAct_endDate">
                        </div>
                        <div class="col-12 col-md-4 mb-3">
            ...
            <div class="modal fade" id="finModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="createUpdateModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content" style="width: 100%;">
                  <div class="modal-header">
                    <h5 class="modal-title" id="createUpdateModalLabel">MARCAR COMO SUBACTIVIDAD FINALIZADA</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body ">
