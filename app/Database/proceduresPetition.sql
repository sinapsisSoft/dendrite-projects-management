...
INNER JOIN petition_status PET_STA ON PET.Petition_status_id=PET_STA.Petition_status_id
INNER JOIN petition_type PET_TYPE ON PET.Petition_type_id=PET_TYPE.Petition_type_id
...
CREATE PROCEDURE `sp_select_status_petitions` ()   BEGIN
    SELECT Petition_status_id,Petition_status_name FROM petition_status;
END$$