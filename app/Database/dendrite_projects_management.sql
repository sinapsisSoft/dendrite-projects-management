...
CREATE TABLE IF NOT EXISTS `activities` (
  ...
  `Activi_observation` varchar(1000) NOT NULL,
  `Activi_startDate` date DEFAULT NULL,
  `Activi_endDate` date NOT NULL,
  `Activi_link` varchar(3000) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `project` (
  ...
  `Manager_id` int(11) NOT NULL,
  `Brand_id` int(11) NOT NULL,
  `Project_purchaseOrder` varchar(100) NOT NULL,
  ...
  `Project_observation` varchar(1000) NOT NULL,
  `Project_percentage` varchar(15) DEFAULT NULL,
  `Project_url` varchar(3000) DEFAULT NULL,
  `Client_id` int(11) NOT NULL,
  `User_id` int(11) DEFAULT NULL,
  `Project_commercial` int(11) DEFAULT NULL,
  `Stat_id` int(11) NOT NULL,
  `Priorities_id` int(11) DEFAULT NULL,
  `Project_invoice` varchar(30) DEFAULT NULL,
  `Project_invoiceState` varchar(100) DEFAULT NULL,
  `Project_invoiceDate` date DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
...
CREATE TABLE IF NOT EXISTS `project_request` (
  ...
  `Brand_id` int(11) NOT NULL,
  `ProjReq_observation` varchar(1000) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `project_tracking` (
  ...
  `ProjectTrack_description` varchar(1000) DEFAULT NULL,
  `Project_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `subactivities` (
  ...
  `SubAct_description` varchar(1000) NOT NULL,
