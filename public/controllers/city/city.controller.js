...
const arMessages = new Array('Revise la información suministrada', 'Ciudad creada exitosamente', 'Ciudad actualizada exitosamente', 'Ciudad eliminada exitosamente', 'La ciudad no pudo ser eliminada. Revise si éste está siendo usada.');
const ruteContent = "city/";
const nameModel = 'cities';
const dataModel = 'data';
const dataResponse = 'response';
const dataMessages = 'message';
const dataCsrf = 'csrf';

const primaryId = 'City_id';
