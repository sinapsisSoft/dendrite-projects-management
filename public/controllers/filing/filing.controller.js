...
const arMessages = new Array('Revise la información suministrada', 'Presentación creada exitosamente', 'Presentación actualizada exitosamente', 'Presentación eliminada exitosamente', 'La presentación no pudo ser eliminada. Revise si ésta está siendo usada en algún producto.');
const ruteContent = "filing/";
const nameModel = 'filings';
const dataModel = 'data';
const dataResponse = 'response';
const dataMessages = 'message';
const dataCsrf = 'csrf';

const primaryId = 'Filing_id';
const URL_ROUTE = BASE_URL + ruteContent;

const TOASTS = new STtoasts();
const myModalObjec = '#createUpdateModal';
const idForm = 'objForm';
const infoUrl = 'https://ior.ad/9iBm';
