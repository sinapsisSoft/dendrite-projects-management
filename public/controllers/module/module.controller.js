...
const arMessages = new Array('Revise la información suministrada', 'Módulo creado exitosamente', 'Módulo actualizado exitosamente', 'Módulo eliminado exitosamente', 'El Módulo no pudo ser eliminado. Revise si éste está siendo usado por algún rol.');
const ruteContent = "module/";
const nameModel = 'modules';
const dataModel = 'data';
const dataResponse = 'response';
const dataMessages = 'message';
const dataCsrf = 'csrf';

const primaryId = 'Mod_id';
const URL_ROUTE = BASE_URL + ruteContent;

const TOASTS = new STtoasts();
const myModalObjec = '#createUpdateModal';
const idForm = 'objForm';
const infoUrl = 'https://ior.ad/9kBF';
